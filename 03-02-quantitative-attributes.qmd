...
#| fig-alt: "Histogram of admission rates for the institutions of higher learning in the sample."
...
#| fig-alt: "Histogram of college admission rates. Here the color of the bin lines to black and fill in the bars with yellow. Axes labels are also added to the plot."
...
A full description of a quantitative distribution includes shape, center, and variation. Here is how we might describe the distribution of admission rates presented in @fig-density-01:
...
1. Interpret the bar that is immediately to the left of 1.00.
...
2. Create a density plot for the distribution of median earnings for students. Add appropriate labels to the axes.
...
```{r}
#| fig-alt: "Density plot of median arnings."
gf_density(
...
3. Describe the shape, center, and variation of this distribution and what it tells you about students' median earnings 10 years after being enrolled in college.
