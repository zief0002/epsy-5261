...
The data in [bachelor.csv](https://raw.githubusercontent.com/zief0002/epsy-5261/main/data/bachelor.csv) include data on $n=50$ contestants on ABC's television show *The Bachelor* and *The Bachelorette*. 
...
# View data
readr::read_csv(file = "https://raw.githubusercontent.com/zief0002/epsy-5261/main/data/bachelor.csv") |>
  print(width = Inf)
```
