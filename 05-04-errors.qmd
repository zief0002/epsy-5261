...
1. Based on the results of the one-sample *t*-test, $t(29) = -0.41$, $p = 0.687$, which type of error could we have made if we were using an $\alpha$-value of .05? Explain.  
...
2. Using the context of the problem (i.e., survey responses of the assessment of prior knowledge) and the hypotheses tested, what does it mean to make this type of error? 
...
3. Based on the results of the one-sample *t*-test, $t(14) = 3.12$, $p = 0.004$, which type of error could we have made if we were using an $\alpha$-value of .01? Explain.  
...
4. Using the context of the problem (i.e., house prices near the UMN campus) and the hypotheses tested, what does it mean to make a this type of error? 
...
5. Based on the results of the two-sample *t*-test, $t(35) = 2.47$, $p = 0.009$, which type of error could we have made if we were using an $\alpha$-value of .05? Explain. Also, using the context of the problem and the hypotheses tested, what does it mean to make a this type of error? 
...
6. Based on the results of the two-sample *z*-test, $z = -.772$, $p = 0.440$, which type of error could we have made if we were using an $\alpha$-value of .05? Explain. Also, using the context of the problem and the hypotheses tested, what does it mean to make a this type of error? 
