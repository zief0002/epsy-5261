...
The data in [public.csv](https://raw.githubusercontent.com/zief0002/epsy-5261/main/data/public.csv) are the $N=71$ public institutions from the original 230 randomly sampled institutions drawn from the 2020--21 data (see [here](https://zief0002.github.io/epsy-5261/codebooks/college-scorecard.html)).
...
- `control`: Institutional control (Private, Public)
...
#| echo: false
# Import data
public_colleges = readr::read_csv(file = "https://raw.githubusercontent.com/zief0002/epsy-5261/main/data/public.csv")

# View data
DT::datatable(public_colleges)
```
