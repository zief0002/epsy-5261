...
2. Interpret the CI you computed.
...
3. Based on the CI, is it more detrimental on IQ for people who became persistent marijuana users as adults or those that became persistent marijuana users as teens? Explain.
...
5. Use the CI to compute the margin of error. Remember a CI is computed as $\text{Sample Estimate} \pm \text{Margin of Error}$.
