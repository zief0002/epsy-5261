...
1. Import the [fastx-reviews.csv](https://raw.githubusercontent.com/zief0002/epsy-5261/main/data/fastx-reviews.csv) data and compute the proportion of all critics' "Fresh" reviews.
...
2. Use the `nrow()` function to compute the sample size. Just input the name of the data frame object into this function.
...
3. Use the formula (and R) to compute Cohen's *h* comparing the sample proportion of "fresh" reviews to the hypothesized value of 0.5. Also indicate the magnitude of the effect based on Cohen's guidelines.
...
4. Use the `ci_cohens_h()` function to compute the 95% confidence interval for the population effect in the Rotten Tomatoes example comparing to the hypothesized value of 0.5. For the sample size corresponding to the hypothesized value in the function, enter the value `Inf`.
...
5. Interpret the CI by commenting on the potential direction and magnitude of the effect.
...
6. Use the `ci_risk_ratio()` function to compute the risk ratio and the 99% CI for the population risk ratio that compares the proportion of "Fresh" reviews to the hypothesized value of 0.5.
...
7. Interpret the confidence interval by commenting on the plausible values in the interval. 
