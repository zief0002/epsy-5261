...
```{r}
#| label: fig-scatterplot-colleges
#| fig-cap: "Scatterplot displaying the relationship between 75th percentile ACT score and completion rates for the 92 institutions in the sample. The fitted linear regression line is also displayed on the plot."
#| fig-alt: "Scatterplot displaying the relationship between 75th percentile ACT score and completion rates for the 92 institutions in the sample. The fitted linear regression line is also displayed on the plot."
...
#| fig-alt: "Plot displaying the 75th ACT scores and completion rates along with the fitted regression line (blue). A visual representation of each university's residual (green lines) is also displayed."
#| echo: false
#| message: false
...
#| fig-cap: "Scatterplot displaying the relationship between 75th ACT scores and completion rates. The fitted intercept-only linear regression line is also displayed on the plot."
#| fig-alt: "Scatterplot displaying the relationship between 75th ACT scores and completion rates. The fitted intercept-only linear regression line is also displayed on the plot."
