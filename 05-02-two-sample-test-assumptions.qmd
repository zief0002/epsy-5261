...
#| fig-alt: "Five simple random samples of size 14 and 23 drawn from a normal population."
#| echo: false
#| fig-width: 10
#| fig-height: 4
#| out-width: "100%"
...
1. In the Bachelor and Bachelorette ages case study from @sec-two-sample-t-test, we evaluated whether, on average, there were age differences between those people selected to be The Bachelor and those selected to be The Bachelorette. The histograms for the sample distributions of ages is shown below. Based on this plot and the sample size, do you believe the normality assumption is tenable?
...
2. Based on the data collection process described in the [data codebook](https://zief0002.github.io/epsy-5261/codebooks/bachelor.html), do you believe the independence assumption is tenable?
...
3. Based on the summary statistics provided below, do you believe the equal variances assumption is tenable?
