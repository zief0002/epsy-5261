...
```{r}
#| label: fig-density-completion
#| fig-cap: "Density plot of completion rates for the 92 institutions in the sample."
#| fig-alt: "Density plot of completion rates for the 92 institutions in the sample."
...
```{r}
#| label: fig-density-act
#| fig-cap: "Density plot of 75th percentile ACT scores for the 92 institutions in the sample."
#| fig-alt: "Density plot of 75th percentile ACT scores for the 92 institutions in the sample."
...
```{r}
#| label: fig-scatterplot-wines
#| fig-cap: "Scatterplot displaying the relationship between 75th percentile ACT scores and completion rates for the 92 institutions in the sample."
#| fig-alt: "Scatterplot displaying the relationship between 75th percentile ACT scores and completion rates for the 92 institutions in the sample."
...
#| fig-alt: "Scatterplot displaying the relationship between 75th percentile ACT scores and completion rates. The OLS fitted regression line is also displayed. The blue point is the mean completion rate for colleges with a 75th percentile ACT score of 21."
#| echo: false
#| message: false
...
<span class="output1">lm(`**outcome** ~ `1 + ` **predictor**, `data =` **dataframe**`)</span>
...
```{r}
#| label: fig-regression-marquette
