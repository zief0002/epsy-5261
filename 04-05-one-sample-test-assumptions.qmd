...
#| fig-alt: "Density plots for five samples of size 75 that were actually drawn from a population that was normally distributed."
#| message: false
#| echo: false
#| warning: false
#| fig-width: 15
...
2. Based on the data collection process described in the [data codebook](https://zief0002.github.io/epsy-5261/codebooks/continuous-assessment.html), do you believe the independence assumption is tenable?
...
4. Based on the data collection process described in the [data codebook](https://zief0002.github.io/epsy-5261/codebooks/zillow.html), do you believe the independence assumption is tenable?
