...
#| fig-alt: "Thought experiment for drawing random samples of size 75 from the population to obtain different samples. The average amount of sleep per night is computed for each sample drawn."
#| out-width: "100%"
#| echo: FALSE
...
#| fig-alt: "Distribution of 1000 sample means. Each observation in the distribution is a mean indicating the average amount of sleep per night for one sample. The red dots show the means computed from @fig-thought-experiment."
#| fig-width: 8
#| fig-height: 5
#| out-width: "90%"
#| echo: FALSE
...
#| fig-alt: "Visual depiction of how to estimate the standard deviation in a unimodal symmetric distribution."
#| out-width: "80%"
#| echo: FALSE
