...
```{r}
#| label: fig-bach-seg
#| fig-cap: "Segmented bar chart showing the proportion of Bachelor and Bachelorette contestants who are still together."
#| fig-alt: "Segmented bar chart showing the proportion of Bachelor and Bachelorette contestants who are still together."
...
```{r}
#| label: fig-bach-seg2
#| fig-cap: "Segmented bar chart showing the proportion of Bachelor and Bachelorette contestants who are still together. The fill color was selelected manually using hex codes."
#| fig-alt: "Segmented bar chart showing the proportion of Bachelor and Bachelorette contestants who are still together. The fill color was selelected manually using hex codes."
...
```{r}
#| label: fig-bach-seg3
#| fig-cap: "Segmented bar chart showing the proportion of Bachelor and Bachelorette contestants who are still together. The fill color, based only on non-missing values, was selelected manually using hex codes."
#| fig-alt: "Segmented bar chart showing the proportion of Bachelor and Bachelorette contestants who are still together. The fill color, based only on non-missing values, was selelected manually using hex codes."
#| 
# Syntax to create a segmented bar chart for the still_together attribute
# A seperate bar is show for each show
...
$$
\begin{split}
z &= \frac{.11 - .19}{\sqrt{\frac{.11(1 - .11)}{27} + \frac{.19(1 - .19)}{21}}} \\[2ex]
&= \frac{-.08}{.105} \\[2ex]
&= -0.762
\end{split}
$$
...
#| fig-alt: "Density plot of the *z*-distribution of the difference in sample proportions based on the thought experiment underlying a hypothesis test assuming that the difference in proportion of Bachelor and Bachelorette contestants who are still together with their selected suitor is 0. The red vertical line represents the observed *z*-value of -.772. The shaded area under the curve to the left of -.772 and to the right of +.772 shows the associated *p*-value of .440 that corresponds to the probability of seeing an observed result of -.772 (or a result more extreme than that) if the null hypothesis that the two population proportions are equal is true."
#| fig-width: 6
#| fig-height: 4
#| out-width: "80%"
...
1. Similar to hypotheses we wrote for the two-sample *t*-test, hypotheses in which we compare two samples' proportions can also be written as differences. Re-write the null and alternative hypotheses as differences.
