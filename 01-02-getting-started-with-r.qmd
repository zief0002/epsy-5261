...
```{r}
#| label: fig-script-file-with-comments
#| fig-cap: "Example script file with comments."
#| fig-alt: "Example script file with comments."
#| echo: false
#| out-width: "90%"
...
1. Open a new script file and add the some syntax to sum two numbers. Also add a comment to describe this computation. Save your script file to your computer.

<button class="solution-btn solution-btn-default" onclick="toggle_visibility('exercise_script');">Show/Hide Solution</button>

<div id="exercise_script" style="display:none; margin: -40px 0 40px 40px;">
```{r}
#| label: fig-ans
#| fig-cap: "Example script file showing how to sum two numbers. This also includes a comment."
#| fig-alt: "Example script file showing how to sum two numbers. This also includes a comment."
#| echo: false
#| out-width: "90%"
knitr::include_graphics("figs/exercise-script.png")
```

</div>

2. Run the syntax to sum two numbers from your script file.

<button class="solution-btn solution-btn-default" onclick="toggle_visibility('exercise_script-run');">Show/Hide Solution</button>

<div id="exercise_script-run" style="display:none; margin: -40px 0 40px 40px;">
