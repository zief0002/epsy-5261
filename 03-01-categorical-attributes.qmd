...
#| fig-alt: Bar chart indicating the counts of each type of pet owned. In this plot the categories are placed on the *y*-axis and the scale on the the *x* axis indicates proportions rather than counts.
#| echo: false
...
#| fig-alt: "Bar chart summarizing the counts of the control attribute."
...
Create a bar chart by modeling the counts of the `control` attribute in the `colleges` data object.
:::
...
#| fig-alt: "Bar chart summarizing the counts of institutions of higher learning by type."
...
#| fig-alt: "Bar chart summarizing the proportions of institutions of higher learning by type."
...
#| fig-alt: "Bar chart summarizing the percentage of institutions of higher learning by type."
...
#| fig-alt: "Horizontal bar chart summarizing the number of institutions of higher learning by type."
#| fig-width: 8
#| fig-height: 5
...
1. Write the syntax to compute the counts of the `region` attribute.
...
2. Write the syntax to compute the proportions of the `region` attribute.
...
3. Write the syntax to create a bar chart that summarizes the counts of the `region` attribute.
...
4. Add better labels to the *x*- and *y*-axis of the bar chart you just created.
...
5. Write the syntax to create a bar chart that summarizes the proportions of the `region` attribute. Also change the axis labels on both the *x*- and *y*-axes.
...
6. Write the syntax to create a horizontal bar chart that summarizes the percent of the `region` attribute. Also change the axis labels on both the *x*- and *y*-axes.
